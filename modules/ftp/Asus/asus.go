...
func (a *Asus) SetDeviceName(device ...string) {
	a.DeviceName = "Asus"
}

func (a *Asus) Patterns() []map[string]interface{} {
	return []map[string]interface{}{}
}

func (a *Asus) Filters(banner map[string]interface{}) bool {
	if banner["banner"] == nil {
		return false
	}
	if val, ok := banner["banner"].(string); ok {
		if strings.Contains(val, "FTP service") && strings.Contains(val, "220 Welcome to ASUS") {
			return true
		}
	}
	return false
...
func (a *Asus) DeviceScan(banner map[string]interface{}) bool {
...
func (a *Asus) CveScan(els *handler.Elastic) {
...
func (a *Asus) PrintInfo() string { return model.Category.Router() + " | Asus" }

func (a *Asus) Result() model.ModuleStructure {
