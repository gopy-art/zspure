...
func (c *CiscoIos) Patterns() []map[string]interface{} {
	return []map[string]interface{}{
		{"result.response.headers.server": "cisco-IOS"},
	}
}
...
func (c *CiscoIos) DeviceScan(banner map[string]interface{}) bool {
	...
	c.ExtraInformation.SetExtraInfo("operating_system", "IOS")
	return false
}
...
func (c *CiscoIos) PrintInfo() string { return model.Category.Router() + " | Cisco IOS" }
