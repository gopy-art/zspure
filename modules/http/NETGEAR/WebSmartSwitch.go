...
func (n *WebSmartSwitch) SetCategory(category ...string) {
	n.Category = model.Category.Switch()
}

func (n *WebSmartSwitch) SetDeviceName(device ...string) {
	n.DeviceName = "NETGEAR Web Smart Switch"
}

func (a *WebSmartSwitch) Patterns() []map[string]interface{} {
	return []map[string]interface{}{
		{"result.response.body": "NETGEAR Web Smart Switch"},
	}
}

func (n *WebSmartSwitch) Filters(banner map[string]interface{}) bool {
	if banner["response"] == nil {
		return false
	}
	if val, ok := banner["response"].(map[string]interface{})["body"]; ok {
		if strings.Contains(val.(string), "NETGEAR Web Smart Switch") && 
...
func (n *WebSmartSwitch) DeviceScan(banner map[string]interface{}) bool {
...
func (n *WebSmartSwitch) CveScan(els *handler.Elastic) {
...
func (n *WebSmartSwitch) PrintInfo() string { return model.Category.Switch() + " | NETGEAR Web Smart Switch" }

func (n *WebSmartSwitch) Result() model.ModuleStructure {
