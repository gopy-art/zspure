...
func (c *CiscoASA) SetCategory(category ...string) {
	c.Category = model.Category.Firewall()
}

func (c *CiscoASA) SetDeviceName(device ...string) {
	c.DeviceName = "Cisco ASA"
}

func (a *CiscoASA) Patterns() []map[string]interface{} {
	return []map[string]interface{}{
		{"result.response.body": "<html><script>document.location.replace(\"/+CSCOE+/logon.html\")</script></html>"},
	}
}

func (c *CiscoASA) Filters(banner map[string]interface{}) bool {
	if banner["response"] == nil {
		return false
	}
	if val, ok := banner["response"].(map[string]interface{})["body"]; ok {
		if strings.Contains(val.(string), "<html><script>document.location.replace(\"/+CSCOE+/logon.html\")</script></html>") &&
...
func (c *CiscoASA) DeviceScan(banner map[string]interface{}) bool {
...
func (c *CiscoASA) CveScan(els *handler.Elastic) {
	...
	if config.LOGIC == "execute" {
		...
		url := fmt.Sprintf(model.CVE.MainResource(), "cisco asa")
...
func (c *CiscoASA) PrintInfo() string { return model.Category.Firewall() + " | Cisco ASA" }

func (c *CiscoASA) Result() model.ModuleStructure {
