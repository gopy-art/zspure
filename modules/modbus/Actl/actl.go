...
func (a *Actl) SetCategory(category ...string) {
	a.Category = model.Category.Industrial()
}

func (a *Actl) SetDeviceName(device ...string) {
	a.DeviceName = "ACTL"
}

func (a *Actl) Patterns() []map[string]interface{} {
	return []map[string]interface{}{
		{"result.mei_response.objects.vendor": "ACTL"},
	}
}

func (a *Actl) Filters(banner map[string]interface{}) bool {
	if banner["mei_response"] == nil {
		return false
	}
	if val, ok := banner["mei_response"].(map[string]interface{})["objects"].(map[string]interface{})["vendor"]; ok {
		if strings.Contains(strings.ToLower(val.(string)), "actl") {
			return true
		}
	}
	return false
...
func (a *Actl) DeviceScan(banner map[string]interface{}) bool {
...
func (a *Actl) CveScan(els *handler.Elastic) {
...
func (a *Actl) PrintInfo() string { return model.Category.Industrial() + " | Actl PLC" }

func (a *Actl) Result() model.ModuleStructure {
