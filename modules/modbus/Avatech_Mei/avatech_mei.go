...
func (a *AvatechMei) SetCategory(category ...string) {
	a.Category = model.Category.Industrial()
}

func (a *AvatechMei) SetDeviceName(device ...string) {
	a.DeviceName = "Avatech Mei"
}

func (a *AvatechMei) Patterns() []map[string]interface{} {
	return []map[string]interface{}{
		{"result.mei_response.objects.vendor": "Avatech"},
	}
}

func (a *AvatechMei) Filters(banner map[string]interface{}) bool {
	if banner["mei_response"] == nil {
		return false
	}
	if val, ok := banner["mei_response"].(map[string]interface{})["objects"].(map[string]interface{})["vendor"]; ok {
		if strings.Contains(strings.ToLower(val.(string)), "avtech") {
			return true
		}
	}
	return false
...
func (a *AvatechMei) DeviceScan(banner map[string]interface{}) bool {
...
func (a *AvatechMei) CveScan(els *handler.Elastic) {
...
func (a *AvatechMei) PrintInfo() string { return model.Category.Industrial() + " | Avatech Mei" }

func (a *AvatechMei) Result() model.ModuleStructure {
