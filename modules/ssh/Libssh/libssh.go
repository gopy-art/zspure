...
func (l *LibSSH) SetCategory(category ...string) {
	l.Category = model.Category.Service()
}

func (l *LibSSH) SetDeviceName(device ...string) {
	l.DeviceName = "LibSSH"
}

func (l *LibSSH) Patterns() []map[string]interface{} {
	return []map[string]interface{}{}
}

func (l *LibSSH) Filters(banner map[string]interface{}) bool {
	if banner["server_id"] == nil {
		return false
	}
	if val, ok := banner["server_id"].(map[string]interface{}); ok && val != nil {
		if v, okk := val["raw"].(string); okk && strings.Contains(strings.ToLower(v), "libssh2") {
			return true
		}
	}
	return false
...
func (l *LibSSH) DeviceScan(banner map[string]interface{}) bool {
	...
	re := regexp.MustCompile(`libssh2_([\d.]+)`)
...
func (l *LibSSH) CveScan(els *handler.Elastic) {
...
func (l *LibSSH) PrintInfo() string { return model.Category.Service() + " | LibSSH" }

func (l *LibSSH) Result() model.ModuleStructure {
